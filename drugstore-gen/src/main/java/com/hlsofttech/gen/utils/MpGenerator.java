package com.hlsofttech.gen.utils;
...
public class MpGenerator {
	public static void main(String[] args) {
		String module="product";//1.包名
		AutoGenerator mpg = new AutoGenerator();

		// 全局配置
		GlobalConfig gc = new GlobalConfig();
		gc.setOutputDir("D://");//2.生成的文件放到D盘下
		...
		strategy.setInclude(new String[] {"drugs_info"}); // 需要生成的表
		// strategy.setExclude(new String[]{"test"}); // 排除生成的表

		// 自定义实体父类
		strategy.setSuperEntityClass("com.hlsofttech.base.BaseModel");
		// 自定义实体，公共字段
		/*strategy.setSuperEntityColumns(new String[] { "create_by", "create_date", "update_by", "update_date",
				"remarks", "del_flag" });*/
		// 自定义 mapper 父类
		strategy.setSuperMapperClass("com.hlsofttech.base.BaseMappers");
		// 自定义 service 父类
		strategy.setSuperServiceClass("com.hlsofttech.base.BaseService");
		// 自定义 service 实现类父类
		strategy.setSuperServiceImplClass("com.hlsofttech.base.BaseServiceImpl");
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.hlsofttech.base.BaseController");
