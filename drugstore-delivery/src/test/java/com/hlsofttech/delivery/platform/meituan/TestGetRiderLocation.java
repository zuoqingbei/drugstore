 ...
 * 获取骑手当前位置
 */
public class TestGetRiderLocation {
    private static final Log logger = LogFactory.getLog(TestGetRiderLocation.class);
    ...
    @Test
    public void testGetRiderLocation() throws Exception {
        ...
        try {
            String res = HttpClient.post(RequestConstant.GET_RIDER_LOCATION, params);
